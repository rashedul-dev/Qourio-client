...
export function AdminCreateParcelDialog({ open, onOpenChange }: CreateParcelDialogProps) {
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input type="email" placeholder="bob@example.com" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      min="0.1"
                      {...field}
                      value={typeof field.value === "number" ? field.value : Number(field.value) || 0.1}
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
