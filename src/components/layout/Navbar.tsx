                  ...
                  <Fragment key={index}>
                    {link.role === "PUBLIC" && (
                      <NavigationMenuItem>
                        <NavigationMenuLink
                          asChild
                          className="text-foreground hover:text-primary py-1.5 font-bold text-lg"
                        >
                          <Link to={link.href}>{link.label}</Link>
                        </NavigationMenuLink>
                      </NavigationMenuItem>
                    ...
                    {link.role === data?.data?.role && (
                      <NavigationMenuItem>
                        <NavigationMenuLink
                          asChild
                          // className="text-muted-foreground hover:text-primary py-1.5 font-bold text-lg bg-red-500 "
                          className="btn-glow-scale hover:bg-red-600 ml-2"
                        >
                          <Link to={link.href}>{link.label}</Link>
                        </NavigationMenuLink>
                      </NavigationMenuItem>
